...
<head>
    ...
    <title>@yield('title', 'ErenBlog')</title>
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="index.html">Gostil Sanat</a>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="site-heading">
                    <h1>Gostil - Makinist</h1>
                    <span class="subheading">laravel denemeleriii</span>
                </div>
            </div>
        </div>
    </div>
